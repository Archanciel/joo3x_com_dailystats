 ...
 *
 */
class EmptyDailyStatsTableOneArticleTest extends DailyStatsCronTestBase {
	/**
	...
	protected function getDataSet() {
		return $this->createXMLDataSet ( dirname ( __FILE__ ) . '\..\..\data\cron\empty_dstable_1_article_test_data.xml' );
	}
}
