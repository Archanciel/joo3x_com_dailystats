 ...
 *
 */
class OneDS1Article2DuplicatedAttach1UnpubAttach2NewValidDSUsrField2UsedTest extends DailyStatsCronTestBase {
	public function testExecDailyStatsCron2NewAttach1UnpubAttach() { 
		...
		$this->assertEquals(3,$count,'3 daily_stats records expected, 2 for the past (for the new main attachment) and 1 for today for article 1 which has now 3 attachments, 1 unpublished, 1 main (user_field_2 empty) and 1 secondary (user_field_2 == 1)');
	...
	protected function getDataSet() {
		return $this->createXMLDataSet ( dirname ( __FILE__ ) . '\..\..\data\cron\1_DS_1_article_test_2_dupl_attach_1_unpub_attach_1_new_valid_DS_data_usr_field2_used.xml' );
	}
}
