 ...
 *
 */
class OneDS1Article2DuplicatedAttach1UnpubAttach2NewValidDSUsrField2NotUsedTest extends DailyStatsCronTestBase {
	public function testExecDailyStatsCron2NewAttach1UnpubAttach() { 
		...
		$query = "SELECT * FROM #__" . $this->getDailyStatsTableName() . " WHERE attachment_id = 10003 AND date = '$today'"; 
    	$db->setQuery($query);
    	$res = $db->loadAssoc();
	...
	protected function getDataSet() {
		return $this->createXMLDataSet ( dirname ( __FILE__ ) . '\..\..\data\cron\1_DS_1_article_test_2_dupl_attach_1_unpub_attach_1_new_valid_DS_data_usr_field2_empty.xml' );
	}
}
